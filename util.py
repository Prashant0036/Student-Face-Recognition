...
def classify_image(image_base64_data, file_path=None):
    ...
    for img in imgs:
        ...
        len_image_array = 200*200*3 + 200*200
...
def load_saved_artifacts():
    ...
    with open("./artifacts/stu_class_dict.json", "r") as f:
        __class_name_to_number = json.load(f)
        __class_number_to_name = {v:k for k,v in __class_name_to_number.items()}

    global __model
    if __model is None:
        with open('./artifacts/saved_model_for_SNC.pkl', 'rb') as f:
...
if __name__ == "__main__":
    ...
    print(classify_image(None, "./testImg/"))